...
docker stop arca-dbbus-go arca-dbbus-db arca-dbbus-db0 arca-dbbus-db-master arca-dbbus-db-view12 arca-dbbus-db-view23 arca-dbbus-db-view123
...
docker run    --rm --name arca-dbbus-go         --net arca-dbbus-net arca-dbbus-go go -- test -v -timeout 10s && \

# Clean-up
docker stop arca-dbbus-db arca-dbbus-db0 arca-dbbus-db-master arca-dbbus-db-view12 arca-dbbus-db-view23 arca-dbbus-db-view123 && \
