...
docker stop arca-dbbus-go arca-dbbus-db arca-dbbus-db0 arca-dbbus-db-ss arca-dbbus-db-master arca-dbbus-db-view12 arca-dbbus-db-view23 arca-dbbus-db-view123
...
docker run -d --rm --name arca-dbbus-db-ss      --net arca-dbbus-net arca-dbbus-db-ss && \
...
# Clean-up
docker stop arca-dbbus-db arca-dbbus-db0 arca-dbbus-db-ss arca-dbbus-db-master arca-dbbus-db-view12 arca-dbbus-db-view23 arca-dbbus-db-view123 && \
